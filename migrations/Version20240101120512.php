 ...
 */
final class Version20240101120512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD type_id INT DEFAULT NULL, ADD url VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image DROP type_id, DROP url');
    }
}
