...
console.log('window.Dropzone auto discover', window.Dropzone);
...
const dropzoneInit = () => {
    ...
    dropzones.forEach(item => {
        ...
        console.log('item.querySelector(Selector.DZ_PREVIEW)', item.querySelector(Selector.DZ_PREVIEW));
        const dropzone = new window.Dropzone(item, options);
        console.log('dropzone after new ', dropzone);
